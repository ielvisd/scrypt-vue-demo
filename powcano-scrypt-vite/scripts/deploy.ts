...
import { PowcanoScryptVite } from '../src/contracts/powcanoScryptVite'
...
async function main() {
    await PowcanoScryptVite.compile()
    ...
    const instance = new PowcanoScryptVite(
    ...
    console.log('PowcanoScryptVite contract was successfully deployed!')
