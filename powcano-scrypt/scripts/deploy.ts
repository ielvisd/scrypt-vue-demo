...
import { PowcanoScrypt } from '../src/contracts/powcanoScrypt'
...
async function main() {
    ...
    const instance = new PowcanoScrypt(
    ...
    console.log('PowcanoScrypt contract was successfully deployed!')
